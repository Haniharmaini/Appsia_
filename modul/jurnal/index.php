<div class="card mb-3">
    <div class="card-body">
        <form action="/proses_form_jurnal" method="post" id="formJurnal">
            <div class="row">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <select class="form-select" name="jenis-invoice" id="jenis-invoice">
            ...
            <div class="row">
                <div class="mb-3 col-md-4">
                    ...
                    <select class="form-select" name="nama-akun" id="nama-akun">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/proses_edit_jurnal" method="post">
                    <div class="row">
                        <div class="mb-3 col-md-4">
                            <label for="invoice" class="form-label">Invoice</label>
                            <input type="text" class="form-control" name="invoice" id="invoice" value="#PB020324">
                        </div>
                        <div class="mb-3 col-md-4">
                            <label for="jenis-invoice" class="form-label">Jenis Invoice</label>
                            <select class="form-select" name="jenis-invoice" id="jenis-invoice">
                        ...
                        <div class="mb-3 col-md-4">
                        <label for="tanggal" class="form-label">Tanggal</label>
                            <input type="date" class="form-control" name="tanggal" id="tanggal" value="2022-03-20">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-4">
                        ...
                        <div class="mb-3 col-md-4">
                            <label for="nominal" class="form-label">Nominal</label>
                            <input type="number" class="form-control" name="nominal" id="nominal" value="10000000">
                        </div>
                        <div class="mb-3 col-md-4">
                            <label for="type" class="form-label">Type</label>
                            <select class="form-select" name="type" id="type">
