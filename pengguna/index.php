    ...
    <div class="card-body">
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="username" clsas="form-label">Username</label>
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                <label for="lavel" class="form-label">Level</lebel>
                           ...
                           <td>
                             <a href="#editpengguna" class="text-decoration-none" data-bs-toggle="modal">
                                ...
                                <a href="" class="text-decoration-none">
                                    <i class="bi bi-trash text-daanger"></i>
                                </a>
                             </td>
                             <!-- Modal -->
                                  ...
                                  <div class="modal-content">
                                     <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <lebel for="username" class="form-label">Username</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="from-select" name="level">
                                                    <option value="admin">Admin</option>
                                                    <option value="user">User</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label class="email" class="form-lebel">Email</label>
